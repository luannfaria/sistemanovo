    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Contaapagar Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="datapagamento" value="<?php echo $this->input->post('datapagamento'); ?>" class="has-datepicker form-control" id="datapagamento" />
						</div>
					</div>
					<div class="col-md-6">
