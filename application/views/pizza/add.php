    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Nova Pizza</h3>
            </div>
            <?php echo form_open('pizza/add'); ?>
          	<div class="box-body">
...
<tbody>
  <tr>
  <td><input type="checkbox" name="pizza[]" value="1" id="bro" onchange="muda(this, 'brotinho');"></td>
...
<tr>
<td><input type="checkbox"  name="pizza[]" value="2" id="fat" onchange="muda(this, 'fatia');"></td>
...
<td>	<input type="text" name="custopizza[2]"  class="form-control" id="fatiac" disabled="true"/></td>
<td><input type="text" name="vendapizza[2]" class="form-control" id="fatiav" disabled="true"/></td>
</tr>
<tr>
<td><input type="checkbox"  name="pizza[]" id="peq" value="3" onchange="muda(this, 'pequena');"></td>
<td>Pequena
...
<tr>
<td><input type="checkbox"  name="pizza[]" value="4" id="med" onchange="muda(this, 'media');"></td>
<td>Media
...
<tr>
<td><input type="checkbox" name="pizza[]" value="5" id="gra" onchange="muda(this, 'grande');"></td>
<td>Grande
...
<tr>
<td><input type="checkbox"  name="pizza[]" value="6" id="gig" onchange="muda(this, 'gigante');"></td>
<td>Gigante
